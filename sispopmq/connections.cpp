...
void SispopMQ::setup_outgoing_socket(zmq::socket_t& socket, std::string_view remote_pubkey) {
...
ConnectionID SispopMQ::connect_sn(std::string_view pubkey, std::chrono::milliseconds keep_alive, std::string_view hint) {
...
ConnectionID SispopMQ::connect_remote(std::string_view remote, ConnectSuccess on_connect, ConnectFailure on_failure,
...
SispopMQ::proxy_connect_sn(std::string_view remote, std::string_view connect_hint, bool optional, bool incoming_only, bool outgoing_only, std::chrono::milliseconds keep_alive) {
