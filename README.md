# SispopMQ - zeromq-based message passing for Sispop projects

This C++17 library contains an abstraction layer around ZeroMQ to support integration with Sispop
...
and local daemon commands, communication channels between sispopd and auxiliary services (storage
...
also allows configuration of how public connections should be treated: for example, a sispopd running
