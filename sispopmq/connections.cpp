...
void SispopMQ::setup_outgoing_socket(zmq::socket_t& socket, string_view remote_pubkey) {
...
ConnectionID SispopMQ::connect_sn(string_view pubkey, std::chrono::milliseconds keep_alive, string_view hint) {
...
ConnectionID SispopMQ::connect_remote(string_view remote, ConnectSuccess on_connect, ConnectFailure on_failure,
...
SispopMQ::proxy_connect_sn(string_view remote, string_view connect_hint, bool optional, bool incoming_only, bool outgoing_only, std::chrono::milliseconds keep_alive) {
