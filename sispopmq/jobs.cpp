...
void SispopMQ::job(std::function<void()> f) {
...
void SispopMQ::proxy_timer(std::function<void()> job, std::chrono::milliseconds interval, bool squelch) {
    if (!timers)
...
void SispopMQ::add_timer(std::function<void()> job, std::chrono::milliseconds interval, bool squelch) {
