...
int SispopMQ::set_zmq_context_option(int option, int value) {
...
zmq::socket_t& SispopMQ::get_control_socket() {
    ...
    // Maps the SispopMQ unique ID to a local thread command socket.
...
SispopMQ::run_info& SispopMQ::run_info::load(batch_job&& bj, bool reply_job) {
    is_batch_job = true;
