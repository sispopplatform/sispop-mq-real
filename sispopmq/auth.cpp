...
bool SispopMQ::proxy_check_auth(size_t conn_index, bool outgoing, const peer_info& peer,
...
void SispopMQ::proxy_set_active_sns(string_view data) {
...
void SispopMQ::proxy_update_active_sns(bt_list_consumer data) {
